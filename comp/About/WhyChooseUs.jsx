...
//         {
//             title: 'Excellence',
//             tagline: 'Excellence is not an act but a habit.',
//         },
//         {
//             title: 'Professionalism',
//             tagline: 'Elevate Excellence: Where Professionalism Takes Center Stage.',
//         },
//         {
//             title: 'Expertise',
//             tagline: 'Masters of Mastery: Unleashing the Power of Expertise.',
//         },
//     ];

//     return (
//         <section className="why-choose-us py-12 px-6 bg-white text-gray-800">
//             <div className="max-w-6xl mx-auto text-center">
//                 <h2 className="text-4xl font-bold text-blue-800 mb-12">Why Choose Us</h2>
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//                     {values.map((item, index) => (
//                         <div
//                             key={index}
//                             className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition duration-300 border border-blue-100"
//                         >
//                             <h3 className="text-2xl font-semibold text-blue-700 mb-4">
//                                 {item.title}
//                             </h3>
//                             <p className="text-lg text-gray-700">{item.tagline}</p>
//                         </div>
//                     ))}
//                 </div>
//             </div>
