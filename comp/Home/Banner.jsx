...
const Banner = () => {
    return (
        <div className="mt-8">
            <div className="flex items-center grid-cols-2 mx-auto overflow-x-hidden lg:grid md:py-14 lg:py-24 xl:py-14 lg:mt-3 xl:mt-5" data-aos="fade-right" data-aos-duration="800">
                <div className="pr-2 w-[5rem]  bg-red-500 md:mb-14 py-14 md:py-0">
                    <h1 className="text-3xl font-semibold text-blue-900 bg-primary xl:text-5xl lg:text-3xl">
                        <span className="text-5xl w-[3rem]  max-w-xl ">{Content?.title}</span>
                    </h1>
                    ...
                    <div className="mt-4">
                        <Link href="/" className=" px-10 py-2 rounded tracking-wider text-white bg-blue-500 md:px-8 hover:bg-blue-600 group">
                            <span className="px-5 ">Explore our services</span>
                        </Link>
                    </div>
                </div>
