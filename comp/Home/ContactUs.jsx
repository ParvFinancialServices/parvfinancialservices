  ...
  return (
    <div className="w-full bg-white py-5">
      <div className=" mx-auto bg-white md:p-4 font-[sans-serif]">
        ...
        <div
          className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
          <div>
