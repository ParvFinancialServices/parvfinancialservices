        ...
        <div className="flex justify-center flex-col w-full">
          ...
          <div className=" mx-auto max-w-[60%]">
            ...
            <p className="text-sm text-gray-500 mt-4 leading-relaxed text-center">
              Have a question about our loan services, or need assistance with
              your application? Whether you're exploring your options or have
              specific inquiries, our friendly and knowledgeable team is here to
              guide you every step of the way.
            </p>
          </div>
        </div>

        <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
          <div>
            <form>
          ...
          <div className="z-10 relative h-full max-md:min-h-[350px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d902.3476113860994!2d84.263993!3d25.223771!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDEzJzI1LjMiTiA4NMKwMTUnNTAuNiJF!5e0!3m2!1sen!2sus!4v1737517951003!5m2!1sen!2sus"
