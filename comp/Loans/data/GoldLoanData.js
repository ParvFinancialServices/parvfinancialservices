export const GoldLoanData = {
    about: {
        title: "About Gold Loan",
        description:
            "A gold loan is a secured loan where you pledge your gold ornaments as collateral to avail instant funds. It’s a fast and reliable way to meet financial needs, offering high loan amounts at low-interest rates."
    },
    features: [
        {
    ...
    additionalBenefits: [
        {
            benefit: "No Prepayment Penalty",
            detail: "Pay off your loan early without any additional charges."
        },
        {
            benefit: "Loan Renewal Facility",
            detail: "Easily renew the loan tenure by paying the accrued interest."
        },
        {
            benefit: "High Security for Gold",
            detail: "Gold is stored securely in a bank locker or vault during the loan term."
        },
        {
            benefit: "No Credit Score Check",
            detail: "A poor credit score does not impact gold loan eligibility."
        },
        {
            benefit: "Immediate Liquidity",
            detail: "Turn idle gold into cash for emergencies or planned needs."
        }
    ],
    documents: [
        {
        ...
        {
            type: "Gold Ownership Proof",
            details: [
                "Jewelry invoice (if available)"
            ]
        }
    ]
};
