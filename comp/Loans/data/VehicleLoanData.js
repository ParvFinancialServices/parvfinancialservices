export const VehicleLoanData = {
    about: {
        title: "About Vehicle Loan",
        description:
            "A vehicle loan helps individuals purchase their dream car or two-wheeler with affordable financing options. These loans cover a significant portion of the vehicle's cost, allowing you to repay in easy installments."
    },
    features: [
        {
    ...
    additionalBenefits: [
        {
            benefit: "Customizable EMI Options",
            detail: "Flexibility to choose EMI amounts based on your budget."
        },
        {
            benefit: "Prepayment Facility",
            detail: "Option to prepay the loan amount with minimal or no charges."
        },
        {
            benefit: "Loan Coverage for Accessories",
            detail: "Funding available for additional accessories or insurance."
        },
        {
            benefit: "No Hidden Charges",
            detail: "Transparent policies with no undisclosed fees."
        },
        {
            benefit: "Special Discounts",
            detail: "Exclusive benefits for specific vehicle models and partnerships."
        }
    ],
    documents: [
        {
        ...
        },
        {
            ...
            details: [
                ...
                "ITR filings for the last 2 years (for self-employed)"
            ]
        },
        {
