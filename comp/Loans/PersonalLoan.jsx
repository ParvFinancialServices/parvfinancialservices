...
function Header() {
    return (
        <header className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-800">Personal Loans</h1>
            <p className="text-gray-600 mt-2">
                Achieve your personal goals and meet financial needs with flexible and quick personal loans.
            </p>
        </header>
    );
}
...
function Footer() {
    return (
        <footer className="text-center text-gray-500 mt-12">
            <p>Parv Financial Services - Supporting you with tailored financial solutions for your needs.</p>
        </footer>
    );
}
