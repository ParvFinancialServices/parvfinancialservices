...
import { DSAAccountCreation } from "@/config/forms/AccountCreation";

const ApplyForDSA = () => {
  const [formData, setFormData] = useState(DSAAccountCreation);
          ...
          <form onSubmit={handleSubmit} className="container mx-auto mb-8">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                />
                {errors.landmark && (
                  <p className="text-red-500">{errors.landmark}</p>
                )}
              </div>
              <div>
                <Input
